...
// 获取access_token
function getAccessToken(config, allData = {}) {
    ...
    return new Promise((resolve, reject) => {
        ...
        get(url, {
            ...
            // 写入文件
            allData[appID] = res
            fs.writeFileSync(accessTokenPath, JSON.stringify(allData, null, 4))
...
module.exports = (config) => {
    ...
    if (!fs.existsSync(accessTokenPath)) {
        ...
        let allData = JSON.parse(fs.readFileSync(accessTokenPath, 'utf-8'))
        ...
        // 过期了，重新获取
            ...
            return getAccessToken(config, allData)
        }
